...
## e2e: Live end-to-end tests against real Cloudflare/Google DoH (network required)
e2e: build
...
BREW_KIND := formula
BREW_DESC := Collect a domain's DNS records over DoH (out-of-band, distinguishable)
